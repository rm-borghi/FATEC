...
-- Table `lt_ctt_end`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `lt_ctt_end` ;

CREATE TABLE IF NOT EXISTS `lt_ctt_end` (
  ...
  CONSTRAINT `ceFkIdCtt`
    ...
    REFERENCES `tb_contatos` (`idCtt`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ceFkidEnd`
    FOREIGN KEY (`ce_fk_idEnd`)
    REFERENCES `tb_endereco` (`idEnd`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `tb_pacientes` (
  ...
  CONSTRAINT `pcFK_idCttEnd`
    ...
    REFERENCES `lt_ctt_end` (`idCttEnd`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- Table `tb_humordia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tb_humordia` ;

CREATE TABLE IF NOT EXISTS `tb_humordia` (
...
*/
-- -----------------------------------------------------
-- Insert de Usuário ROOT
-- -----------------------------------------------------
INSERT INTO `TB_Root` (`idRoot`, `rtUser`, `rtPwd`) 
	VALUES ('1', 'root', 'root');
